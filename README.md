...
- `lib/rating-colors.js` — the 0–11 ladder shared with the exporter. It must stay
  identical between the app, the exporter and this page. Change one, change both.
- `lib/catalog.json`, `lib/stats.json` — generated from the review store. Real numbers
