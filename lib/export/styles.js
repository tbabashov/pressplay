...
export const STYLES = {
  ...
  paper: {
    ...
    dome: false,
    type: { displayWeight: 700, displayTrack: '-0.5px', labelTrack: '0.09em', labelCase: 'uppercase', labelWeight: 600, coverRadius: '2px',  chipRadius: '6px' },
    looks: [],
    name: 'Paper',
  ...
  mono: {
    ...
    dome: false,
    type: { displayWeight: 500, displayTrack: '1.2px',  labelTrack: '0.19em', labelCase: 'uppercase', labelWeight: 500, coverRadius: '4px',  chipRadius: '4px' },
    looks: [],
    name: 'Mono',
  ...
  aurora: {
    ...
    dome: true,
    type: { displayWeight: 750, displayTrack: '-1.4px', labelTrack: '0.12em',  labelCase: 'uppercase', labelWeight: 700, coverRadius: '34px', chipRadius: '999px' },
    looks: ['dome'],
    name: 'Aurora',
