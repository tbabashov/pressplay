...
export async function listAllPublishedLite () {
  return (await backend()).listAllPublishedLite()
}
export async function listReviewsLite (email) {
  return (await backend()).listReviewsLite(email)
}
...
export async function deleteAccountData (email) {
  return (await backend()).deleteAccountData(email)
}
export async function deleteAccount (email) {
  return (await backend()).deleteAccount(email)
}

// ---------- Slide generations ----------
export async function recordGeneration (email, albumId) {
  return (await backend()).recordGeneration(email, albumId)
}
export async function countGenerationsToday (email) {
  return (await backend()).countGenerationsToday(email)
}
export async function generatedToday (email, albumId) {
  return (await backend()).generatedToday(email, albumId)
}
...
export async function listPublishedReviews (opts) {
  return (await backend()).listPublishedReviews(opts)
}

export async function createReset (tokenHash, email, expiresAt) {
  return (await backend()).createReset(tokenHash, email, expiresAt)
}

export async function takeReset (tokenHash) {
  return (await backend()).takeReset(tokenHash)
}

export async function clearResets (email) {
  return (await backend()).clearResets(email)
}

export async function setSubscription (email, sub) {
  return (await backend()).setSubscription(email, sub)
}

export async function markSubscriptionCancelled (email, patch) {
  return (await backend()).markSubscriptionCancelled(email, patch)
}

export async function getProfileBySubscription (subscriptionId) {
  return (await backend()).getProfileBySubscription(subscriptionId)
}
