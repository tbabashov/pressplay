...
export default function Hero({ albums = [], children }) {
  ...
  // A new record starts with no panel: it is the thing pressing play gets you.
  useEffect(() => {
    setSettled(false);
  }, [i]);
  ...
  // The panel is the answer to pressing play, so it waits for the record to be
      ...
      <div className="hero-inner">
        <div className="hero-copy">
          ...
          <p className="hero-sub measure">
            Score an album track by track, publish the review, and argue about
            it with people who care as much as you do. Every rating comes out
            the other side as a set of slides built for TikTok.
          </p>
            ...
            >
              ...
              <button
                ...
                aria-label={
                  spinning
                    ? `Pause ${album.name}`
                    : `Play a preview of ${album.name} by ${album.artist}`
                }
              >
                <img
                  ref={art}
                ...
                <span className="sleeve-btn" aria-hidden="true">
                  {spinning ? (
                    ...
                    <svg viewBox="0 0 24 24">
                      <path d="M8.5 5.6v12.8a.8.8 0 0 0 1.22.68l10.1-6.4a.8.8 0 0 0 0-1.36L9.72 4.92a.8.8 0 0 0-1.22.68Z" />
                    </svg>
                  )}
                </span>
              </button>
